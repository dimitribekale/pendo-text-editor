...
def main():
    ...
    training_args = TrainingArguments(
        ...
        eval_strategy="steps",
        eval_steps=200,  # Increased frequency for 5x larger dataset
        num_train_epochs=6,  # Increased from 3 for better convergence
        ...
        warmup_steps=800,  # ~10% of total steps (~7,440) for 500k samples
        max_grad_norm=1.0,
        bf16=True,
        save_strategy="steps",
    ...
    print("="*60)
    print("Starting IMPROVED teacher model training...")
    print("Dataset: 500k samples (~120M tokens, 5x larger)")
    print("Epochs: 6 (2x more training)")
    print("Estimated time: ~10-12 hours on 3x H100 80GB")
    print("Target: Perplexity ~12-15 (vs previous ~20)")
    print("="*60)
    print()
